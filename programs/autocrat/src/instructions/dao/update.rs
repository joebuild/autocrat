...
pub struct UpdateDaoParams {
    ...
    pub amm_initial_quote_liquidity_atomic: Option<u64>,
...
pub fn handler(
    ...
    if let Some(amm_initial_quote_liquidity_atomic) = dao_params.amm_initial_quote_liquidity_atomic {
        dao.amm_initial_quote_liquidity_atoms = amm_initial_quote_liquidity_atomic;
    }
