...
pub mod autocrat {
    ...
    // ==== autocrat
    // can anyone add instructions to anyone else's `ProposalInstructions` account?
    ...
    // floats? floats are pretty scary
    ...
    // is this pretty much pulled directly from conditional vault?
