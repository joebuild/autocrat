...
import { getDaoAddr, getProposalAddr, getProposalInstructionsAddr } from "../../utils";
...
export const createProposalInstructionsHandler = async (
    ...
    let proposalInstructionsAddr = getProposalInstructionsAddr(client.program.programId, daoAddr, proposalAddr)[0]
