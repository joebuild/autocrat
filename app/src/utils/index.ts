...
export const addPriorityFee = (pf: number) => ComputeBudgetProgram.setComputeUnitPrice({
    microLamports: pf
});

export const pubkeyToAccountInfo = (pubkey: PublicKey, isWritable: boolean, isSigner = false): AccountMeta => {
    return {
        pubkey: pubkey,
        isSigner: isSigner,
